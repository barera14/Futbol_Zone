                                                    ...
                                                    <tr>  
                                                      ...
                                                      <td> <c:out value="${cli.direccion}"/></td>
                                                        <td> 
                                                            ...
                                                            <button class="btn btn-sm btn-danger" type="button" title="Editar"  onclick="location.href = 'EstablecimientoC?action=update&id=${cli.idEstablecimiento}'"><i class="mdi mdi-pencil"></i> </button>
                                                            <c:choose>
                                                                
                                                                <c:when  test="${cli.estado eq estado}" >
                                                            <button class="btn btn-sm btn-success" type="button" title="Activar"  onclick="location.href = 'EstablecimientoC?action=activar&id=${cli.idEstablecimiento}'"><i class="mdi mdi-check"></i></button>
                                                               </c:when>
                                                               <c:otherwise>
                                                            <button class="btn btn-sm btn-warning" type="button" title="Inactivar"  onclick="location.href = 'EstablecimientoC?action=inactivar&id=${cli.idEstablecimiento}'"><i class="mdi mdi-close"></i></button>
                                                             </c:otherwise>
                                                            </c:choose>
                                                            </td>
                                                    </tr>

                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <table id="datatable" class="table table-striped table-bordered">
                                         ...
                                         <div class="form-group pull-right">
                                                    <div>
                                                        <button type="reset" class="btn btn-primary waves-effect m-l-5"  onclick="javascript:history.go(-1)"> Ver Tabla posiciones </button></div>
                                                </div>
                                        <div class="form-group pull-right">
                                                    <div>
                                                        <button type="reset" class="btn btn-primary waves-effect m-l-5"  onclick="javascript:history.go(-1)"> Ver Enfrentamientos </button></div>
                                                </div>
                                    </div>
                                </div>
                            </div>

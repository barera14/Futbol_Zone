                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-8 col-xs-12">
                                        ...
                                        <div class="m-t-20">
                                            <form class="" enctype="multipart/form-data"  action="CanchasC?action=create" method="POST">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="file"  accept="image/x-png,image/gif,image/jpeg" required class="filestyle" onchange="nombre(this.value)" data-buttonname="btn-default" id="filestyle-0" name="file"  style="position: realtive; clip: rect(0px 0px 0px 0px);"/>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div> 
                                                        <input type="number" name="valor"   class="form-control" required data-parsley-minlength="4" data-parsley-maxlength="10" placeholder="Valor"/>
                                                    </div>
                                                </div>
                                                <div hidden="hidden" >
                                                    <input type="text" name="foto" id="foto"  class="form-control" placeholder="Valor."/>
                                                </div>                   

...
<html lang="en">
  ...
  <body>
    <!-- Navigation
    ==========================================-->
    <nav id="tf-menu" class="navbar navbar-default navbar-fixed-top" style="background-color: #e66060; height: 80px;">
      <div class="container">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.html">Futbol Zone</a>
        </div>

        <!-- Collect the nav links, forms, and other content for toggling -->
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
            <li><a href="index.html/#tf-home" class="page-scroll">Inicio</a></li>
            <li><a href="index.html/#tf-about" class="page-scroll">Acerca de</a></li>
            <li><a href="Login.html" class="page-scroll">Iniciar Sesion</a></li>
            <li><a href="RegistroClient.jsp" class="page-scroll">Registrar Establecimiento</a></li>
            <li><a href="RegistroEstabPag.jsp" class="page-scroll">Registrar Usuario</a></li>
    ...
    <div id="tf-home" class="text-center">
        <div class="overlay">
            <div class="content">
                <h1 style="color:white">Bienvenido a <strong><span style="color:#e66060;">Futbol Zone</span></strong></h1>
                <br/>
                <h5 style="text-align: center; "<strong>Brindar Nuestras instalaciones para la práctica segura del futbol a todas las personas 
                                que sientan su pasión con este deporte superando las expectativas <br/> de  nuestros clientes, dentro de su ambiente seguro, 
                                 muy limpio
                                y agradable sin distinción socioeconomica, de edad y sexo, ser los semilleros delas futuras 
                                figuras del fútbol, trabajando en equipo con principios éticos y morales.</strong></h5>
                <a href="#tf-about" class="fa fa-angle-down page-scroll" style="color: white; background-color: #e66060; border-color: transparent"></a>
            </div>
        </div>
    </div>
    ...
    <div id="tf-about">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <img style="width: 400px; " src="img/02.png" class="img-responsive">
                </div>
                <div class="col-md-6">
